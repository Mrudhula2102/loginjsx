...
const Trainingedit = (props) => {
    ...
    const traininghandler =(event)=>{
     ...
     const saveData =()=>{
        ...
        (props.method==="put")
        {
            axios.put("http://localhost:4005/training/"+training._id,training)
            .then((response)=>{
                alert("updated")
  ...
  return (
    ...
    <div className='div'>
      ...
      <TextField  label="ID" variant="filled" name="id" value={inputs.idd} onChange={inputhandler}/><br/><br/>
      <TextField  label="name" variant="filled" name="ename" value={inputs.name}  onChange={inputhandler}/><br/><br/>
      ...
      <TextField  label="remarks" variant="filled" name="remarks" value={inputs.remarks}  onChange={inputhandler} /><br/><br/>
      {/* Status: &nbsp;&nbsp;
